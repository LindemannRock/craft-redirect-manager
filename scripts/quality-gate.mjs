...
const workspaceMode = packageRoot === path.join(workspaceRoot, 'plugins/redirect-manager')
...
const constituents = [
    ...
    },
    {
        ...
        workspace: ['ddev', ['exec', 'cd plugins/redirect-manager && bash scripts/composer-audit']],
    },
    {
        id: 'php-quality',
        family: 'php-static-style',
        standalone: ['composer', ['ci']],
        workspace: ['ddev', ['exec', 'cd plugins/redirect-manager && composer ci']],
    },
    {
        id: 'test-conventions',
        family: 'test-conventions',
        standalone: ['php', ['scripts/check-test-conventions.php']],
        workspace: ['ddev', ['exec', 'cd plugins/redirect-manager && php scripts/check-test-conventions.php']],
    },
    {
        id: 'runner-lifecycle-regressions',
        family: 'runner-lifecycle',
        standalone: ['php', ['tests/Fixtures/Project/run.php', '--lifecycle-probe']],
        workspace: ['ddev', ['exec', 'cd plugins/redirect-manager && REDIRECT_MANAGER_FIXTURE_SOURCE_VENDOR_ROOT=/var/www/html/vendor php tests/Fixtures/Project/run.php --lifecycle-probe']],
        standaloneEnvironment: {
            REDIRECT_MANAGER_FIXTURE_SOURCE_VENDOR_ROOT: runtimeVendorRoot,
        },
    },
    {
        ...
        workspace: ['ddev', ['exec', 'cd plugins/redirect-manager && REDIRECT_MANAGER_FIXTURE_SOURCE_VENDOR_ROOT=/var/www/html/vendor php tests/Fixtures/Project/run.php --no-progress']],
        standaloneEnvironment: {
            REDIRECT_MANAGER_FIXTURE_SOURCE_VENDOR_ROOT: runtimeVendorRoot,
        },
    },
    ...
    {
        id: 'build-package-boundaries',
        family: 'build-package-boundaries',
...
console.log('\nComplete Redirect Manager quality gate passed.');
