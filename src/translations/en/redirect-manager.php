...
return [
    ...
    'The backup could not be completed. Check the configured backup storage and permissions, then try again.' => 'The backup could not be completed. Check the configured backup storage and permissions, then try again.',
    'The local backup storage could not be accessed. Check the configured path and permissions, then try again.' => 'The local backup storage could not be accessed. Check the configured path and permissions, then try again.',
    'Backups could not be loaded. Check the configured backup storage and try again.' => 'Backups could not be loaded. Check the configured backup storage and try again.',
    'Import was stopped because the safety backup could not be completed.' => 'Import was stopped because the safety backup could not be completed.',
    'The backup ZIP could not be prepared. Check the configured backup storage and try again.' => 'The backup ZIP could not be prepared. Check the configured backup storage and try again.',
    'Restore was stopped because a safety backup of the current redirects could not be completed.' => 'Restore was stopped because a safety backup of the current redirects could not be completed.',
    'The backup could not be restored. Check the selected backup and configured backup storage, then try again.' => 'The backup could not be restored. Check the selected backup and configured backup storage, then try again.',
    'The backup could not be deleted. Check the configured backup storage and permissions, then try again.' => 'The backup could not be deleted. Check the configured backup storage and permissions, then try again.',
    ...
    'Cleared {count, plural, =1{# analytics record} other{# analytics records}}.' => 'Cleared {count, plural, =1{# analytics record} other{# analytics records}}.',
    ...
    'Cleared {count, plural, =1{# redirect cache} other{# redirect caches}}.' => 'Cleared {count, plural, =1{# redirect cache} other{# redirect caches}}.',
    ...
    'Cleared {redirectCount, plural, =1{# redirect cache} other{# redirect caches}} and {deviceCount, plural, =1{# device cache} other{# device caches}}.' => 'Cleared {redirectCount, plural, =1{# redirect cache} other{# redirect caches}} and {deviceCount, plural, =1{# device cache} other{# device caches}}.',
    ...
    'Enter a path (/page), a full URL (https://example.com), or a contact link (e.g. mailto:, tel:). Protocol-relative URLs (//host) are not allowed.' => 'Enter a path (/page), a full URL (https://example.com), or a contact link (e.g. mailto:, tel:). Protocol-relative URLs (//host) are not allowed.',
...
• Recommended to keep enabled for production sites',
    ...
    'Maximum requests per minute for the JSON API endpoint. Set to 0 to disable rate limiting.' => 'Maximum requests per minute for the JSON API endpoint. Set to 0 to disable rate limiting.',
    ...
    'Download the Postman collection and environment to test the Redirect Manager API outside Craft.' => 'Download the Postman collection and environment to test the Redirect Manager API outside Craft.',
    ...
    'The destination to redirect to — a path or full URL (e.g., /new-page or https://example.com/new-page).' => 'The destination to redirect to — a path or full URL (e.g., /new-page or https://example.com/new-page).',
    'The destination to redirect to. Use $1 to append the part of the URL after your matched prefix (e.g., /new-section/$1 or https://example.com/new-section/$1).' => 'The destination to redirect to. Use $1 to append the part of the URL after your matched prefix (e.g., /new-section/$1 or https://example.com/new-section/$1).',
    'The destination to redirect to. Use $1, $2, etc. to insert each * from your source pattern, in order (e.g., /new-blog/$1 or https://example.com/new-blog/$1).' => 'The destination to redirect to. Use $1, $2, etc. to insert each * from your source pattern, in order (e.g., /new-blog/$1 or https://example.com/new-blog/$1).',
    'The destination to redirect to. Use $1, $2, etc. to insert your regex capture groups (e.g., /new-recipes/$1 or https://example.com/new-recipes/$1).' => 'The destination to redirect to. Use $1, $2, etc. to insert your regex capture groups (e.g., /new-recipes/$1 or https://example.com/new-recipes/$1).',
    ...
    'No request type data available for the selected filters.' => 'No request type data available for the selected filters.',
    ...
    'These redirects already exist with the same source URL and site scope.' => 'These redirects already exist with the same source URL and site scope.',
    'Reason' => 'Reason',
    ...
    'Invalid source match mode: {redirectSrcMatch}' => 'Invalid source match mode: {redirectSrcMatch}',
    'Invalid priority: {priority}. Priority must be a whole number from 0 to 9.' => 'Invalid priority: {priority}. Priority must be a whole number from 0 to 9.',
    'Invalid status code: {statusCode}' => 'Invalid status code: {statusCode}',
    'Already exists with the same source URL and site scope' => 'Already exists with the same source URL and site scope',
    ...
    'Permanently clear all analytics tracking data. This action cannot be undone!' => 'Permanently clear all analytics tracking data. This action cannot be undone!',
    ...
    'Are you sure you want to permanently clear ALL analytics data? This action cannot be undone!' => 'Are you sure you want to permanently clear ALL analytics data? This action cannot be undone!',
    ...
    'Clear this analytics record?' => 'Clear this analytics record?',
    'Analytics record cleared' => 'Analytics record cleared',
    'Could not clear analytics record' => 'Could not clear analytics record',
    'Clear {count} analytics record?' => 'Clear {count} analytics record?',
    'Clear {count} analytics records?' => 'Clear {count} analytics records?',
    ...
    'v{version}' => 'v{version}',
    'IP salt' => 'IP salt',
    'Analytics needs a privacy salt before redirect tracking is ready.' => 'Analytics needs a privacy salt before redirect tracking is ready.',
    'Analytics privacy salt is ready for redirect tracking.' => 'Analytics privacy salt is ready for redirect tracking.',
    ...
    'This is being overridden by the <code>apiEndpointRateLimit</code> setting in <code>config/redirect-manager.php</code>.' => 'This is being overridden by the <code>apiEndpointRateLimit</code> setting in <code>config/redirect-manager.php</code>.',
];
